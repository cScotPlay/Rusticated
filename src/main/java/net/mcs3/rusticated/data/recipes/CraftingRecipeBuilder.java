...
public class CraftingRecipeBuilder extends FabricRecipeProvider {
    ...
    public CraftingRecipeBuilder(FabricDataOutput dataGenerator) {
        super(dataGenerator);
    }
    ...
    public void buildRecipes(Consumer<FinishedRecipe> exporter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_IRON, 2).define('#', Items.IRON_INGOT).define('x', Items.CHAIN).pattern(" # ").pattern("x x").pattern("###").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_GOLD, 2).define('#', Items.GOLD_INGOT).define('x', ModBlocks.CHAIN_GOLD.asItem()).pattern(" # ").pattern("x x").pattern("###").unlockedBy("has_gold", has(Items.GOLD_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_COPPER, 2).define('#', Items.COPPER_INGOT).define('x', ModBlocks.CHAIN_COPPER.asItem()).pattern(" # ").pattern("x x").pattern("###").unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHAIN_GOLD).define('#', Items.GOLD_INGOT).define('x', Items.GOLD_NUGGET).pattern("x").pattern("#").pattern("x").unlockedBy("has_gold", has(Items.GOLD_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHAIN_COPPER).define('#', Items.COPPER_INGOT).define('x', ModItems.COPPER_NUGGET).pattern("x").pattern("#").pattern("x").unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHAIN_WAXED_COPPER).requires(ModBlocks.CHAIN_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHAIN_WAXED_EXPOSED_COPPER).requires(ModBlocks.CHAIN_EXPOSED_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHAIN_WAXED_WEATHERED_COPPER).requires(ModBlocks.CHAIN_WEATHERED_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHAIN_WAXED_OXIDIZED_COPPER).requires(ModBlocks.CHAIN_OXIDIZED_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_WAXED_COPPER).requires(ModBlocks.CHANDELIER_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_WAXED_EXPOSED_COPPER).requires(ModBlocks.CHANDELIER_EXPOSED_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_WAXED_WEATHERED_COPPER).requires(ModBlocks.CHANDELIER_WEATHERED_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHANDELIER_WAXED_OXIDIZED_COPPER).requires(ModBlocks.CHANDELIER_OXIDIZED_COPPER).requires(Items.HONEYCOMB).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.STORAGE_BARREL).define('#', Items.IRON_INGOT).define('x', ItemTags.WOODEN_SLABS).define('p', ItemTags.PLANKS).pattern("pxp").pattern("# #").pattern("pxp").unlockedBy("has_wood", has(Blocks.OAK_PLANKS)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.LIQUID_BARREL).define('#', Items.IRON_INGOT).define('x', ItemTags.WOODEN_SLABS).define('p', ItemTags.PLANKS).pattern("p p").pattern("# #").pattern("pxp").unlockedBy("has_wood", has(Blocks.OAK_PLANKS)).save(exporter);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.UNFIRED_JAR).define('#', Items.CLAY_BALL).define('x', Items.CLAY).pattern(" # ").pattern("# #").pattern("xxx").unlockedBy("has_clay", has(Blocks.CLAY)).save(exporter);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModBlocks.UNFIRED_JAR.asItem()), RecipeCategory.BUILDING_BLOCKS, ModBlocks.FIRED_JAR.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModBlocks.FIRED_JAR.asItem()), RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_JAR_0.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.JARS), RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_JAR_0.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Items.CLAY)).save(exporter, new ResourceLocation("glazed_jar_from_glazed_jar"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_JAR_1).requires(ModItemTags.JARS).requires(Items.WHITE_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_JAR_2).requires(ModItemTags.JARS).requires(Items.BLACK_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_JAR_3).requires(ModItemTags.JARS).requires(Items.BROWN_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_JAR_4).requires(ModItemTags.JARS).requires(Items.GREEN_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.UNFIRED_POT).define('#', Items.CLAY_BALL).define('x', Items.CLAY).pattern("# #").pattern("x x").pattern("xxx").unlockedBy("has_clay", has(Blocks.CLAY)).save(exporter);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModBlocks.UNFIRED_POT.asItem()), RecipeCategory.BUILDING_BLOCKS, ModBlocks.FIRED_POT.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModBlocks.FIRED_POT.asItem()),RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_POT_0.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItemTags.POTS), RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_POT_0.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Items.CLAY)).save(exporter, new ResourceLocation("glazed_pot_from_glazed_pot"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_POT_1).requires(ModItemTags.POTS).requires(Items.WHITE_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_POT_2).requires(ModItemTags.POTS).requires(Items.BLACK_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_POT_3).requires(ModItemTags.POTS).requires(Items.BROWN_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLAZED_POT_4).requires(ModItemTags.POTS).requires(Items.GREEN_DYE).unlockedBy("has_clay", has(Items.CLAY)).save(exporter);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRON_LATTICE, 16).define('#', Items.IRON_INGOT).pattern(" # ").pattern("###").pattern(" # ").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(exporter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FERTILE_SOIL).define('#', Blocks.DIRT).define('x', Items.GREEN_DYE).define('t', Items.BONE_MEAL).pattern(" x ").pattern("t#t").unlockedBy("has_dirt", has(Blocks.DIRT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRONWOOD_WOOD).define('#', ModBlocks.IRONWOOD_LOG).pattern("##").pattern("##").unlockedBy("has_log", has(ModBlocks.IRONWOOD_LOG)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.STRIPPED_IRONWOOD_WOOD).define('#', ModBlocks.STRIPPED_IRONWOOD_LOG).pattern("##").pattern("##").unlockedBy("has_log", has(ModBlocks.STRIPPED_IRONWOOD_LOG)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRONWOOD_PLANKS, 4).requires(ModItemTags.IRONWOOD_LOGS).unlockedBy("has_ironwood", has(ModBlocks.IRONWOOD_LOG)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.IRONWOOD_SLAB, 6).define('#', ModBlocks.IRONWOOD_PLANKS).pattern("###").unlockedBy("has_ironwood", has(ModBlocks.IRONWOOD_PLANKS)).save(exporter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.OLIVE_WOOD).define('#', ModBlocks.OLIVE_LOG).pattern("##").pattern("##").unlockedBy("has_log", has(ModBlocks.OLIVE_LOG)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.STRIPPED_OLIVE_WOOD).define('#', ModBlocks.STRIPPED_OLIVE_LOG).pattern("##").pattern("##").unlockedBy("has_log", has(ModBlocks.STRIPPED_OLIVE_LOG)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.OLIVE_PLANKS, 4).requires(ModItemTags.OLIVE_LOGS).unlockedBy("has_olive", has(ModBlocks.OLIVE_LOG)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.OLIVE_SLAB, 6).define('#', ModBlocks.OLIVE_PLANKS).pattern("###").unlockedBy("has_olive", has(ModBlocks.OLIVE_PLANKS)).save(exporter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CROP_STAKE, 4).define('#', ItemTags.PLANKS).pattern(" #").pattern(" #").pattern(" #").unlockedBy("has_planks", has(ItemTags.PLANKS)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ROPE, 1).define('#', Items.STRING).pattern(" #").pattern(" #").pattern(" #").unlockedBy("has_string", has(Items.STRING)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModItems.GRAPE_SEEDS).requires(ModItems.GRAPES).unlockedBy("has_grapes", has(ModItems.GRAPES)).save(exporter);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CONDENSER).define('#', Blocks.BRICKS).define('^', Blocks.WHITE_TERRACOTTA).define('@', Items.BUCKET).pattern("# #").pattern("^@^").pattern("#^#").unlockedBy("has_bricks", has(Blocks.BRICKS)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RETORT).define('#', Blocks.BRICKS).define('^', Items.IRON_INGOT).define('@', Items.BUCKET).pattern(" #").pattern("^@").pattern(" #").unlockedBy("has_bricks", has(Blocks.BRICKS)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ADV_CONDENSER).define('#', Blocks.NETHER_BRICKS).define('^', Blocks.IRON_BLOCK).define('@', Items.BUCKET).pattern("# #").pattern("^@^").pattern("#^#").unlockedBy("has_nether_bricks", has(Blocks.NETHER_BRICKS)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ADV_RETORT).define('#', Blocks.NETHER_BRICKS).define('^', Items.IRON_INGOT).define('@', Items.BUCKET).pattern(" #").pattern("^@").pattern(" #").unlockedBy("has_nether_bricks", has(Blocks.NETHER_BRICKS)).save(exporter);

        RecipeProvider.getSmeltingRecipeName(ModBlocks.EVAPORATING_BASIN.asItem());
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItems.UNFIRED_EVAPORATING_BASIN), RecipeCategory.BUILDING_BLOCKS, ModBlocks.EVAPORATING_BASIN.asItem(), 0.0F, 1600).unlockedBy("has_clay", has(Blocks.CLAY)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CRUSHING_TUB).define('x', ItemTags.WOODEN_SLABS).define('@', Items.IRON_INGOT).define('^', ItemTags.PLANKS).pattern("^ ^").pattern("@ @").pattern("xxx").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.OAK_BREWING_BARREL).define('x', Items.OAK_SLAB).define('@', Items.IRON_INGOT).define('^', Items.OAK_PLANKS).pattern("^@^").pattern("x x").pattern("^@^").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(exporter);
        ...
        /////                  ITEMS                   /////
        ////////////////////////////////////////////////////
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.CATALOG).define('#', Items.BOOK).define('x', Items.IRON_NUGGET).define('t', ModItems.OLIVES).pattern(" t ").pattern("x#x").pattern(" x ").unlockedBy("has_catalog", has(ModItems.CATALOG)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, ModItems.COPPER_NUGGET, 9).requires(Items.COPPER_INGOT).unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(exporter, new ResourceLocation("copper_nugget_from_copper_ingot"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, Items.COPPER_INGOT).define('#', ModItems.COPPER_NUGGET).pattern("###").pattern("###").pattern("###").unlockedBy("has_catalog", has(ModItems.CATALOG)).save(exporter, new ResourceLocation("copper_ingot_from_copper_nugget"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModFluids.ALE_WORT_BUCKET).define('#', Items.BREAD).define('^', Items.SUGAR).define('@', Items.WATER_BUCKET).pattern("#^").pattern("@ ").unlockedBy("has_sugar", has(Items.SUGAR)).save(exporter);

        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ModItems.TINY_IRON_DUST), RecipeCategory.BUILDING_BLOCKS, Items.IRON_NUGGET, 0.0F, 25).unlockedBy("has_tiny_iron", has(ModItems.TINY_IRON_DUST)).save(exporter, new ResourceLocation(Items.IRON_NUGGET.toString() + "_smelting"));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItems.TINY_IRON_DUST), RecipeCategory.BUILDING_BLOCKS, Items.IRON_NUGGET, 0.0F, 25).unlockedBy("has_tiny_iron", has(ModItems.TINY_IRON_DUST)).save(exporter, new ResourceLocation(Items.IRON_NUGGET.toString() + "_blasting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.UNFIRED_EVAPORATING_BASIN).define('#', Blocks.CLAY).pattern("# #").pattern(" # ").unlockedBy("has_clay", has(Blocks.CLAY)).save(exporter);
        ...
        BrewingBarrelRecipeBuilder.brewing(ModFluids.ALE_CUP.getDefaultInstance(), ModFluids.SOURCE_ALE_WORT.getSource(), ModFluids.SOURCE_ALE.getSource()).unlockedBy("has_iron_berries", has(ModFluids.ALE_WORT_BUCKET)).save(exporter, new ResourceLocation(MODID, "brewed_ale"));
        BrewingBarrelRecipeBuilder.brewing(ModFluids.CIDER_CUP.getDefaultInstance(), ModFluids.SOURCE_APPLE_JUICE.getSource(), ModFluids.SOURCE_CIDER.getSource()).unlockedBy("has_apples", has(Items.APPLE)).save(exporter, new ResourceLocation(MODID,"brewed_cider"));
        BrewingBarrelRecipeBuilder.brewing(ModFluids.IRON_WINE_CUP.getDefaultInstance(), ModFluids.SOURCE_IRONBERRY_JUICE.getSource(), ModFluids.SOURCE_IRON_WINE.getSource()).unlockedBy("has_iron_berries", has(ModItems.IRON_BERRIES)).save(exporter, new ResourceLocation(MODID,"brewed_iron_wine"));
        BrewingBarrelRecipeBuilder.brewing(ModFluids.MEAD_CUP.getDefaultInstance(), ModFluids.SOURCE_HONEY.getSource(), ModFluids.SOURCE_MEAD.getSource()).unlockedBy("has_honey", has(Items.HONEYCOMB)).save(exporter, new ResourceLocation(MODID,"brewed_mead"));
        BrewingBarrelRecipeBuilder.brewing(ModFluids.SWEET_BERRY_WINE_CUP.getDefaultInstance(), ModFluids.SOURCE_SWEET_BERRY_JUICE.getSource(), ModFluids.SOURCE_SWEET_BERRY_WINE.getSource()).unlockedBy("has_sweet_berries", has(Items.SWEET_BERRIES)).save(exporter, new ResourceLocation(MODID,"brewed_sweet_berry_wine"));
        BrewingBarrelRecipeBuilder.brewing(ModFluids.WINE_CUP.getDefaultInstance(), ModFluids.SOURCE_GRAPE_JUICE.getSource(), ModFluids.SOURCE_WINE.getSource()).unlockedBy("has_grapes", has(ModItems.GRAPES)).save(exporter, new ResourceLocation(MODID,"brewed_wine"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Items.GLASS_BOTTLE).requires(ModItemTags.BOOZE_ITEMS).unlockedBy("has_bottle", has(Items.GLASS_BOTTLE)).save(exporter, new ResourceLocation(MODID, "alcoholic_drink_to_glass_bottle"));

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_APPLE).define('#', Items.APPLE).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.APPLE));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_BAKED_POTATO).define('#', Items.BAKED_POTATO).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.BAKED_POTATO));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_BEEF).define('#', Items.BEEF).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.BEEF));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_BEETROOT).define('#', Items.BEETROOT).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.BEETROOT));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_BEETROOT_SOUP).define('#', Items.BEETROOT_SOUP).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.BEETROOT_SOUP));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_BREAD).define('#', Items.BREAD).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.BREAD));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_CARROT).define('#', Items.CARROT).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.CARROT));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_CHICKEN).define('#', Items.CHICKEN).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.CHICKEN));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_CHORUS_FRUIT).define('#', Items.CHORUS_FRUIT).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.CHORUS_FRUIT));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COD).define('#', Items.COD).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COD));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_BEEF).define('#', Items.COOKED_BEEF).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_BEEF));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_CHICKEN).define('#', Items.COOKED_CHICKEN).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_CHICKEN));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_COD).define('#', Items.COOKED_COD).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_COD));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_MUTTON).define('#', Items.COOKED_MUTTON).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_MUTTON));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_PORKCHOP).define('#', Items.COOKED_PORKCHOP).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_PORKCHOP));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_RABBIT).define('#', Items.COOKED_RABBIT).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_RABBIT));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKED_SALMON).define('#', Items.COOKED_SALMON).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKED_SALMON));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_COOKIE).define('#', Items.COOKIE).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.COOKIE));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_DRIED_KELP).define('#', Items.DRIED_KELP).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.DRIED_KELP));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_GOLDEN_APPLE).define('#', Items.GOLDEN_APPLE).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.GOLDEN_APPLE));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_GOLDEN_CARROT).define('#', Items.GOLDEN_CARROT).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.GOLDEN_CARROT));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_MELON_SLICE).define('#', Items.MELON_SLICE).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.MELON_SLICE));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_MUSHROOM_STEW).define('#', Items.MUSHROOM_STEW).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.MUSHROOM_STEW));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_MUTTON).define('#', Items.MUTTON).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.MUTTON));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_POISONOUS_POTATO).define('#', Items.POISONOUS_POTATO).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.POISONOUS_POTATO));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_PORKCHOP).define('#', Items.PORKCHOP).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.PORKCHOP));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_POTATO).define('#', Items.POTATO).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.POTATO));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_PUFFERFISH).define('#', Items.PUFFERFISH).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.PUFFERFISH));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_PUMPKIN_PIE).define('#', Items.PUMPKIN_PIE).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.PUMPKIN_PIE));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_RABBIT).define('#', Items.RABBIT).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.RABBIT));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_RABBIT_STEW).define('#', Items.RABBIT_STEW).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.RABBIT_STEW));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_ROTTEN_FLESH).define('#', Items.ROTTEN_FLESH).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.ROTTEN_FLESH));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_SALMON).define('#', Items.SALMON).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.SALMON));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_SPIDER_EYE).define('#', Items.SPIDER_EYE).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.SPIDER_EYE));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_SUSPICIOUS_STEW).define('#', Items.SUSPICIOUS_STEW).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.SUSPICIOUS_STEW));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_SWEET_BERRIES).define('#', Items.SWEET_BERRIES).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.SWEET_BERRIES));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.OILED_GLOW_BERRIES).define('#', Items.GLOW_BERRIES).define('^', ModItems.OLIVE_OIL_BOTTLE).pattern("#^").unlockedBy("has_olive_oil", has(ModItems.OLIVE_OIL_BOTTLE)).save(exporter, new ResourceLocation("oiled_" + Items.GLOW_BERRIES));
    }

    public static void coloredWoodRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.PLANKS).define('x', input).pattern("###").pattern("#x#").pattern("###").group("painted_wood").unlockedBy("has_plank", has(Blocks.OAK_PLANKS)).save(exporter);
    }
    ...
    public static void coloredStairsRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input, ItemLike dyeInput, @Nullable String dyedRecipeName)
    {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.WOODEN_STAIRS).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("painted_stairs").unlockedBy("has_stair", has(Blocks.OAK_PLANKS)).save(exporter, new ResourceLocation(dyedRecipeName));
    }
    ...
    {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 6).define('#', inputCutter).pattern("###").group("colored_cobblestone").unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', itemTagKey).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("colored_cobblestone").unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE)).save(exporter, new ResourceLocation(dyedRecipeName));
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, output, inputCutter, 2);
    }
    ...
    {
//        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blocks.STONE, 8)
//                .pattern("###")
//                .pattern("#x#")
//                .pattern("###")
//                .define('#', ModItemTags.COLORED_STONE)
//                .define('x', dyeInput)
//                .unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE))
//                .save(exporter, new ResourceLocation(dyedRecipeName));





        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, output, 8).define('#', ModItemTags.COLORED_STONE).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("colored_cobblestone").unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE)).save(exporter, new ResourceLocation(dyedRecipeName));
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(cobbleItem), RecipeCategory.BUILDING_BLOCKS, output, 0.0F, 200).unlockedBy("has_stone", has(Items.STONE)).save(exporter, new ResourceLocation(dyedRecipeName) + "_smelted");
    }

    public static void coloredCobbleStoneRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike dyeInput)
    {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ModItemTags.COLORED_COBBLESTONE).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("colored_cobblestone").unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE)).save(exporter);
    }
    ...
    {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 4).define('#', inputCutter).pattern("#  ").pattern("## ").pattern("###").group("colored_cobblestone").unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', itemTagKey).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("colored_cobblestone").unlockedBy("is_cobblestone", has(Blocks.COBBLESTONE)).save(exporter, new ResourceLocation(dyedRecipeName));
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, output, inputCutter, 1);
    }
    ...
    {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 6).define('#', inputCutter).pattern("###").pattern("###").unlockedBy(getHasName(materialBlock), has(materialBlock)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', itemTagKey).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("colored_cobblestone").unlockedBy(getHasName(materialBlock), has(materialBlock)).save(exporter, new ResourceLocation(dyedRecipeName));
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, output, inputCutter);
    }
    ...
    {
        slab(exporter, RecipeCategory.BUILDING_BLOCKS, output, input);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.WOODEN_SLABS).define('x', dyeInput).pattern("###").pattern("#x#").pattern("###").group("painted_slabs").unlockedBy("has_slab", has(Blocks.OAK_PLANKS)).save(exporter, new ResourceLocation(dyedRecipeName));
    }

    public static void frameCrossedRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.PLANKS).define('x', input).define('t', Items.STICK).pattern("#t#").pattern("txt").pattern("#t#").group("framed_walls").unlockedBy("has_wool", has(Blocks.OAK_PLANKS)).save(exporter);
    }

    public static void frameRtDiagRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.PLANKS).define('x', input).define('t', Items.STICK).pattern("# #").pattern(" xt").pattern("#t#").group("framed_walls").unlockedBy("has_wool", has(Blocks.OAK_PLANKS)).save(exporter);
    }

    public static void frameLeftDiagRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.PLANKS).define('x', input).define('t', Items.STICK).pattern("# #").pattern("tx ").pattern("#t#").group("framed_walls").unlockedBy("has_wool", has(Blocks.OAK_PLANKS)).save(exporter);
    }

    public static void frameWallRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 8).define('#', ItemTags.PLANKS).define('x', input).pattern("# #").pattern(" x ").pattern("# #").group("framed_walls").unlockedBy("has_wool", has(Blocks.OAK_PLANKS)).save(exporter);
    }

    public static void pathRecipe(Consumer<FinishedRecipe> exporter, ItemLike output, ItemLike input, ItemLike inputCutter)
    {
        stonecutterResultFromBase(exporter, RecipeCategory.BUILDING_BLOCKS, output, inputCutter, 16);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 16).define('#', input).pattern("# #").pattern(" # ").pattern("###").group("path_blocks").unlockedBy("is_path", has(Blocks.STONE)).save(exporter);
    }
