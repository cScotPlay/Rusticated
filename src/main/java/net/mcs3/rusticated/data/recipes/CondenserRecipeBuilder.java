...
public class CondenserRecipeBuilder implements RecipeBuilder {
    ...
    private final RecipeSerializer<? extends CondenserRecipe.Serializer> serializer;

    private CondenserRecipeBuilder(Potion elixir, List<Ingredient> ingredients, RecipeSerializer<? extends CondenserRecipe.Serializer> condenserCookingSerializer) {
    ...
    public static CondenserRecipeBuilder cooking(List<Ingredient> ingredient, Potion elixirEffect, RecipeSerializer<? extends CondenserRecipe.Serializer> serializer) {
        return new CondenserRecipeBuilder(elixirEffect, ingredient, serializer);
    }

    public static CondenserRecipeBuilder condenser(List<Ingredient> ingredient, Potion elixerEffect) {
        return CondenserRecipeBuilder.cooking(ingredient, elixerEffect, ModRecipes.CONDENSER_RECIPE_SERIALIZER);
    }
...
//        finishedRecipeConsumer.accept(new CondenserRecipeBuilder.Result(recipeId, this.group == null ? "" : this.group, this.ingredients, this.elixirEffect, this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/" + this.result.getItem().getItemCategory().getRecipeFolderName() + "/" + recipeId.getPath()), this.serializer));
    ...
    public static class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation resourceLocation, String string, List<Ingredient> ingredients, Potion elixir, Advancement.Builder builder, ResourceLocation resourceLocation2, RecipeSerializer<? extends CondenserRecipe.Serializer> recipeSerializer) {
