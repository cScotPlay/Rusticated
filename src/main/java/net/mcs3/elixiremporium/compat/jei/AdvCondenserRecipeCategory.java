...
public class AdvCondenserRecipeCategory implements IRecipeCategory<AdvCondenserRecipe> {
    ...
    public final static RecipeType<AdvCondenserRecipe> TYPE = RecipeType.create(ElixirEmporium.MOD_ID, "adv_condenser", AdvCondenserRecipe.class);
    public final static ResourceLocation UID = new ResourceLocation(ElixirEmporium.MOD_ID, "adv_condenser");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(ElixirEmporium.MOD_ID, "textures/gui/container/jei_advcondenser.png");
