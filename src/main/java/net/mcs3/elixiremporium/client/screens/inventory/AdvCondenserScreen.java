...
public class AdvCondenserScreen extends AbstractContainerScreen<AdvCondenserMenu> {
    private static final ResourceLocation ADV_CONDENSER_GUI_TEXTURE = new ResourceLocation(ElixirEmporium.MOD_ID,"textures/gui/container/advcondenser.png");
    ...
    protected void renderBg(PoseStack poseStack, float partialTick, int mouseX, int mouseY)
    {
        ...
        if(menu.isCrafting())
        {
            ...
            if ((n = BUBBLELENGTHS[m / 2 % 7]) > 0) {
                this.blit(poseStack, i + 74, j + 14 + 28 - n, 176, 85 - n, 11, n);
            }
        }
