...
import net.mcs3.elixiremporium.network.syncher.EvaporatingSyncS2CPacket;
...
public class ModNetworkSync {
    ...
    public static final ResourceLocation EVAPORATING_SYNC = new ResourceLocation(ElixirEmporium.MOD_ID, "evaporating_sync");
